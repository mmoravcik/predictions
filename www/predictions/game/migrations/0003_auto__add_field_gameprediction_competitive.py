...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GamePrediction.competitive'
        db.add_column('game_gameprediction', 'competitive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GamePrediction.competitive'
        db.delete_column('game_gameprediction', 'competitive')
